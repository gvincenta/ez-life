...
router.post('/', passport.authenticate("jwt", {session : false}) , transactionController.createNewTransaction);
...
router.put('/',  passport.authenticate("jwt", {session : false}) ,transactionController.updateTransaction);
