...
class Calendar extends React.Component {
	...
	   	
		if ((yearVal % 4 === 0 && yearVal % 100 !== 0) || yearVal % 400 === 0) {
			...
			this.setState({daysMonth: [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]})
		}
	...
	render() {
		...
		return(
            <form className="form-inline" >
			    <label className="col-sm-1 col-lg-offset-1 control-label">Date</label>
                    <div className="form-group">
                    <div className ="col-sm-1">
                    
                        <select className="form-control" name="year"  onChange={this.handelChangeYear}>
        ...
                            }
                ...
                <div className ="col-sm-1">
                        ...
                        <select className="form-control" name="month"  onChange={this.handelChangeMonth}>
                ...
                <div className="form-group">
                <div className ="col-sm-1">
                        <select className="form-control" name="day"  onChange={this.handelChangeDay}>
...
export default class CalendarCon extends React.Component {
	...
	render() {
		...
		return(
            <Calendar year={date.getFullYear()} month={date.getMonth()+1} day={date.getDate()}yearList={[2019,2050]}/>
			)
	}
}
